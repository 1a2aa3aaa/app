  ...
  <li v-for="(item,i) in rows" :key="i">
      <div id="list">
          ...
          <div class="bottom">  
             ...
             <a href="javascript:;"><img :src="`${$store.state.pathurl}xinxi1.png`" alt=""></a>
             <!-- 判断是否点过赞 -->
    ...
    methods: {
        ...
        loadList(){
            ...
            this.axios.get(url,{params:obj}).then(res => {
              ...
              //得到帖子所有信息
               for(var key of res.data.rows){
                   ...
                   key.ptitle=key.ptitle.toString().replace(this.val,`<span style="color:red">${this.val}</span>`);
         ...
         //console.log(this.zpid);
                 ...
                 //第一遍从0开始,往后加5
                     for(var i=0;i<this.ppid.length;i++){//遍历判断两个数组里是否有g等的
